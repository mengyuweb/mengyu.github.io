...
function init() {
  ...
  controls.rangeBox = new THREE.Box3(new THREE.Vector3(-0.5, -0.3, -Infinity), new THREE.Vector3(25, 0.3, +Infinity)); //鼠标按钮
...
function fn2d(moon) {
  ...
  moonDiv.id = id;
  moonDiv.innerHTML = '<div class="labelFled"><span>' + title + '</span></div>';
